...
<template>
    <div class="Rules">
        <h1 class="ru-title">REGELWERK</h1>
        <div>
        ...
        <div>
            ...
            Damit ein Treffer gültig ist, muss der Ellenbogen beim Wurf hinter der Kante des Tisches verbleiben.
        ...
        <div>
            ...
            Der zweite Becher wird vom Werfer ausgewählt. 
