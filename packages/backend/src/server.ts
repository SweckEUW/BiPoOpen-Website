...
function connectToMongo() {
    if (!mongoPromise) {
        mongoPromise = mongoose.connect(config.mongo.url, { retryWrites: true, w: 'majority', dbName: "bipoopen", maxPoolSize: 10, serverSelectionTimeoutMS: 30000, socketTimeoutMS: 45000 })
            .then(() => {
